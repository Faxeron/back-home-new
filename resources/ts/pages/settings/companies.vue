...
import { companiesEndpoint } from '@/api/settings'
...
const endpoint = companiesEndpoint({ page, per_page: itemsPerPage })
const { data: response, execute: fetchItems, isFetching } = await useApi<{ data: Company[]; meta: any }>(endpoint)
