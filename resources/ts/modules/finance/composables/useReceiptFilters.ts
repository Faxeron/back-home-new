...
export const defaultReceiptFilters = () => ({
...
interface UseReceiptFiltersOptions {
  onChange?: () => void
  debounceMs?: number
}

export const useReceiptFilters = (options: UseReceiptFiltersOptions = {}) => {
  registerCustomFilters()

  const filters = ref(defaultReceiptFilters())
  ...
  const resetFilters = () => {
    filters.value = defaultReceiptFilters()
    triggerImmediate()
  }
