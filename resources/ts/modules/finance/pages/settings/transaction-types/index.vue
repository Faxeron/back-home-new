...
import TransactionTypesTable from '@/modules/finance/components/settings/TransactionTypesTable.vue'
...
import { TRANSACTION_TYPE_TABLE } from '@/modules/finance/config/transactionTypesTable.config'
