...
import SpendingsTable from '@/modules/finance/components/SpendingsTable.vue'
import { useTableInfinite } from '@/composables/useTableLazy'
import { useSpendingFilters } from '@/modules/finance/composables/useSpendingFilters'
import { SPENDING_TABLE } from '@/modules/finance/config/spendingsTable.config'
