...
## REALITY STATUS
- Реально реализовано: базовая структура (BaseDataTable, useTableLazy, конфиги таблиц) соответствует описанию.
- Легаси: отдельные страницы могут использовать старые таблицы/форматы фильтров.
- Не сделано: URL-sync фильтров и единый контракт фильтрации для всех модулей.
