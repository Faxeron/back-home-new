...
class TransactionFilterDTO extends BaseFilterDTO
{
    public function __construct(
        ...
        public ?int $transactionSign = null,
        ...
        public ?string $contractOrCounterparty = null,
        public ?int $financeObjectId = null,
        public ?bool $unassigned = null,
        public ?int $relatedId = null,
        public ?string $relatedLike = null,
        public ?float $sumMin = null,
        public ?float $sumMax = null,
        public ?bool $isPaid = null,
        public ?bool $isCompleted = null,
        public ?string $notesLike = null,
        public ?string $datePaidFrom = null,
        public ?string $datePaidTo = null,
        public ?string $dateCompletedFrom = null,
        public ?string $dateCompletedTo = null,
    ...
    public static function fromRequest(Request $request, ?int $tenantId): static
    {
        ...
        return new static(
            ...
            transactionSign: $request->filled('sign') ? (int) $request->input('sign') : null,
            ...
            contractOrCounterparty: $request->string('contract_or_counterparty')->toString() ?: null,
            financeObjectId: $request->integer('finance_object_id') ?: null,
            unassigned: $request->filled('unassigned') ? (bool) $request->boolean('unassigned') : null,
            relatedId: $request->integer('related_id') ?: null,
            relatedLike: $request->string('related_like')->toString() ?: null,
            ...
            notesLike: $request->string('notes_like')->toString() ?: null,
            datePaidFrom: $request->date('date_paid_from')?->toDateString(),
            datePaidTo: $request->date('date_paid_to')?->toDateString(),
            dateCompletedFrom: $request->date('date_completed_from')?->toDateString(),
            dateCompletedTo: $request->date('date_completed_to')?->toDateString(),
