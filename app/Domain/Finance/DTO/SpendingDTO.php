...
class SpendingDTO
{
    public function __construct(
        ...
        public readonly ?int $cashflowItemId,
        public readonly ?int $financeObjectId,
    ...
    public static function fromModel(Spending $spending): self
    {
        ...
        return new self(
            ...
            cashflowItemId: $spending->transaction?->cashflow_item_id ? (int) $spending->transaction->cashflow_item_id : null,
            financeObjectId: $spending->finance_object_id ? (int) $spending->finance_object_id : null,
            sum: $sumValue,
