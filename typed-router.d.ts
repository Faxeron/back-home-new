...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'finances-receipts': RouteRecordInfo<'finances-receipts', '/finances/receipts', Record<never, never>, Record<never, never>>,
    'finances-spendings': RouteRecordInfo<'finances-spendings', '/finances/spendings', Record<never, never>, Record<never, never>>,
    'finances-transactions': RouteRecordInfo<'finances-transactions', '/finances/transactions', Record<never, never>, Record<never, never>>,
