...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'dashboards-all': RouteRecordInfo<'dashboards-all', '/dashboards/all', Record<never, never>, Record<never, never>>,
    ...
    'estimate-templates-materials-id': RouteRecordInfo<'estimate-templates-materials-id', '/estimate-templates/materials/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'estimate-templates-materials-new': RouteRecordInfo<'estimate-templates-materials-new', '/estimate-templates/materials/new', Record<never, never>, Record<never, never>>,
    'estimate-templates-septiks': RouteRecordInfo<'estimate-templates-septiks', '/estimate-templates/septiks', Record<never, never>, Record<never, never>>,
    'estimate-templates-septiks-id': RouteRecordInfo<'estimate-templates-septiks-id', '/estimate-templates/septiks/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'estimate-templates-septiks-new': RouteRecordInfo<'estimate-templates-septiks-new', '/estimate-templates/septiks/new', Record<never, never>, Record<never, never>>,
    'estimates': RouteRecordInfo<'estimates', '/estimates', Record<never, never>, Record<never, never>>,
    'estimates-id-edit': RouteRecordInfo<'estimates-id-edit', '/estimates/:id/edit', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'finance-unassigned': RouteRecordInfo<'finance-unassigned', '/finance/unassigned', Record<never, never>, Record<never, never>>,
    ...
    'operations-contracts-templates': RouteRecordInfo<'operations-contracts-templates', '/operations/contracts/templates', Record<never, never>, Record<never, never>>,
    'operations-contracts-templates-id': RouteRecordInfo<'operations-contracts-templates-id', '/operations/contracts/templates/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'operations-contracts-templates-new': RouteRecordInfo<'operations-contracts-templates-new', '/operations/contracts/templates/new', Record<never, never>, Record<never, never>>,
    'operations-finance-objects': RouteRecordInfo<'operations-finance-objects', '/operations/finance-objects', Record<never, never>, Record<never, never>>,
    'operations-finance-objects-id': RouteRecordInfo<'operations-finance-objects-id', '/operations/finance-objects/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'products-brands': RouteRecordInfo<'products-brands', '/products/brands', Record<never, never>, Record<never, never>>,
    'products-categories': RouteRecordInfo<'products-categories', '/products/categories', Record<never, never>, Record<never, never>>,
    'products-estimates': RouteRecordInfo<'products-estimates', '/products/estimates', Record<never, never>, Record<never, never>>,
    'products-price': RouteRecordInfo<'products-price', '/products/price', Record<never, never>, Record<never, never>>,
    ...
    'settings-cashflow-items': RouteRecordInfo<'settings-cashflow-items', '/settings/cashflow-items', Record<never, never>, Record<never, never>>,
    ...
    'settings-sale-types': RouteRecordInfo<'settings-sale-types', '/settings/sale-types', Record<never, never>, Record<never, never>>,
