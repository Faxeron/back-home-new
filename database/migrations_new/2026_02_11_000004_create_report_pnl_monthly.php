...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('report_pnl_monthly', function (Blueprint $table): void {
            $table->id();
            ...
            $table->index(['tenant_id', 'company_id', 'year_month'], 'ix_pnl_monthly_month');
        });
    }

    public function down(): void
    {
        Schema::connection($this->connection)->dropIfExists('report_pnl_monthly');
    }
};
